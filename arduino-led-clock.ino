...
void handleGet(Variable var)
{
    ...
    case Variable::StartTime:
        sendLong(state.stopwatchStartTime);
        break;
    case Variable::PrevTime:
        sendLong(state.stopwatchPrevTime);
        break;
    case Variable::Brightness:
        currentConnection.write(char(state.brightness));
        break;
    case Variable::On:
        currentConnection.write(char(state.on));
        break;
    case Variable::TimeZoneOffset:
        currentConnection.write(char(state.timeZoneOffset));
        break;
    default:
        break;
    }
...
void handleSet()
{
    ...
    case Variable::Brightness:
        ...
        break;
    case Variable::On:
        state.on = bool(data[1]);
        break;
    case Variable::TimeZoneOffset:
        state.timeZoneOffset = static_cast<int8_t>(data[1]);
        break;
    default:
        break;
    }
